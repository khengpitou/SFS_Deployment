                      ...
                      {m_item.singleMegamenu.map((ms_item, ms_i) => (
                        <Link href={`${ms_item.m_childlink}`} key={ms_i}>
                          <div className="flex items-center space-x-2 text-[15px] leading-6 rtl:space-x-reverse">
                            <span
                              className={`h-[6px] w-[6px] rounded-full border border-slate-600 dark:border-white inline-block flex-none ${location === ms_item.m_childlink
                                ? " bg-slate-900 dark:bg-white"
                                : ""
                                }`}
                            ></span>
                            <span
                              className={`capitalize ${location === ms_item.m_childlink
